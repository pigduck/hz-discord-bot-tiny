...
<div id="form-container">
    <?php foreach ($saved_blocks as $index => $block) : ?>
        <div class="form-block">
            <table>
                <tr>
                    <th><?php _e('Type', 'hz-discord-bot-tiny'); ?></th>
                    <td>
                        <label>
                            <select class="hz_discord_webhook_form_blocks_type"
                                    name="hz_discord_webhook_form_blocks[<?php echo $index; ?>][type]">
                    ...
                    <td>
                        <div class="checkbox-group">
                            ...
                            <?php foreach ($order_statuses as $status_key => $status_label): ?>
                                <label>
                                    <input type="checkbox"
                                           name="hz_discord_webhook_form_blocks[<?php echo $index; ?>][status][]"
                    ...
                    <td>
                        <div class="checkbox-group">
                            ...
                            <?php foreach ($all_payment_gateways as $payment_gateway): ?>
                                <label>
                                    <input type="checkbox"
                                           name="hz_discord_webhook_form_blocks[<?php echo $index; ?>][payment][]"
                ...
                <tr>
                    <th><?php _e('Webhooks', 'hz-discord-bot-tiny'); ?></th>
                    <td>
                        <input type="text" name="hz_discord_webhook_form_blocks[<?php echo $index; ?>][webhook]"
                ...
                <tr>
                    ...
                    <td>
                      <textarea name="hz_discord_webhook_form_blocks[<?php echo $index; ?>][message]"><?php echo esc_textarea($block['message'] ?? ''); ?></textarea>
                    </td>
                </tr>
            </table>
